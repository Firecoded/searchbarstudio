// Preview only: the original centered hero, served at /v1 for side-by-side
// comparison. The live hero is ./hero.tsx.
...
export function HeroV1() {
  return (
    <section className="relative flex min-h-[80svh] items-center overflow-hidden">
      ...
      />
      <Container className="hero-rise relative flex w-full flex-col items-center py-16 text-center sm:py-20">
        ...
        <p className="mt-5 max-w-[700px] text-balance text-[17px] leading-[1.55] text-muted sm:mt-6 sm:text-[20px]">
          Spend time on your business, not web design.
        </p>
